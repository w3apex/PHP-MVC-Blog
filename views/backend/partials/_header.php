...
<head>
    ...
    <!--load progress bar-->
    <script src="http://localhost/batch/PHP MVC Blog/public/backend/vendor/pace/pace.min.js"></script>
    <link href="http://localhost/batch/PHP MVC Blog/public/backend/vendor/pace/pace-theme-minimal.css" rel="stylesheet" />
    ...
    <!-- ========================================================= -->
    <!--Notification msj-->
    <link rel="stylesheet" href="http://localhost/batch/PHP MVC Blog/public/backend/vendor/toastr/toastr.min.css">
    <!--Magnific popup-->
    <link rel="stylesheet" href="http://localhost/batch/PHP MVC Blog/public/backend/vendor/magnific-popup/magnific-popup.css">
    <!--TEMPLATE css-->
    <!-- ========================================================= -->
